            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="group relative">
                  <h3 className="mt-3 text-lg font-semibold leading-6 text-neutral-700 dark:text-neutral-100 group-hover:text-brand-500">
                    {post.title}
                  </h3>
                  <p className="hidden sm:block mt-5 text-sm leading-6 text-neutral-500 dark:text-neutral-400">
